document.addEventListener('DOMContentLoaded', function() {
    const baseUrl = 'https://api-rest-manga.onrender.com'; // URL base para la API
    const cardsContainer = document.getElementById('cards-container'); // Contenedor de las tarjetas

    // Función para capitalizar el título
    ...
    // Función para crear una tarjeta de manga
    ...
    // Función asíncrona para cargar mangas desde la API
    ...
    // Event listener para manejar los clics en los botones de detalles
    ...
    // Función asíncrona para mostrar el modal de detalles del manga
    ...
    loadMangas(); // Carga los mangas cuando se carga el DOM
});
